...
typedef enum drakvuf_plugin
{
    ...
    PLUGIN_WINDOWMON,
    PLUGIN_LIBRARYMON,
    PLUGIN_JAKUBPLUGINMON,
    PLUGIN_SYSCALLSMYPLUGINMON,
    PLUGIN_DKOMMON,
    PLUGIN_WMIMON,
    PLUGIN_MEMDUMP,
    PLUGIN_APIMON,
...
static const char* drakvuf_plugin_names[] =
{
    ...
    [PLUGIN_JAKUBPLUGINMON] = "jakubpluginmon",
    [PLUGIN_SYSCALLSMYPLUGINMON] = "syscallsmypluginmon",
...
static const bool drakvuf_plugin_os_support[__DRAKVUF_PLUGIN_LIST_MAX][VMI_OS_WINDOWS+1] =
{
    ...
    [PLUGIN_JAKUBPLUGINMON]   = { [VMI_OS_WINDOWS] = 1, [VMI_OS_LINUX] = 0 },
    [PLUGIN_SYSCALLSMYPLUGINMON]   = { [VMI_OS_WINDOWS] = 1, [VMI_OS_LINUX] = 0 },
